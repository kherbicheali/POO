...
\title{Theme: Compte Rendu Conception Orientée Objet des Systèmes de Commande}
...
\begin{center}
    ...
    \textsc{\Large Compte Rendu Conception Orientée Objet des Systèmes de Commande}\\[1cm]
    % Title
    \HRule \\[0.4cm] % saut de ligne
    { \huge  \textsc {Commande d'un Robot Mobile \\[0.4cm] }}
    ...
    \begin{minipage}{0.4\textwidth}
      \begin{flushright} \large
        %%\emph{Tuteur et}
        \emph{Tuteur:} \textsc{M Pascal BERTHOU}
      \end{flushright}
    \end{minipage}
    \vfill
    % Bottom of the page
